...
const int numberOfPotSamplesY = 5;       // Number of pot samples to take (to smooth the values)
...
void loop() 
{
  ...
  { int potValuesY[numberOfPotSamples];
    ...
    potValueY = potValueY / numberofPotSamplesY;
    ...
    int adjustedValueY = map(potValueY, 0, 4095, 32737, -32737);
